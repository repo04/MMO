...
public class HomePage extends BaseClass{
	...
	public void verifyHomePage() {
		...
		assertEquals(driver.findElement(By.xpath("//div[2]/div[3]/div[2]")).getText(), "Enterprise");
		...
		assertEquals(driver.findElement(By.xpath("//div[2]/div[3]/div[3]")).getText(), "100,000+ Geocodes per month");
...
//		assertEquals(driver.findElement(By.xpath("//a[@onclick=\"selectPlan('?plan=gc_5k_monthly')\"]")).getText(), "Choose");
		assertEquals(driver.findElement(By.xpath("//div[3]/div[4]/span")).getText(), "Monthly" + "\n" + "or" + "\n" +"Annually");
		assertEquals(driver.findElement(By.xpath("//div[3]/div[5]")).getText(), "20%+ discount based on volume!");
		assertEquals(driver.findElement(By.xpath("//a[@onclick=\"selectPlan('?plan=free')\"]")).getText(), "Choose");
		assertEquals(driver.findElement(By.xpath("//a[@onclick=\"selectPlan('?plan=gc_5k_monthly')\"]")).getText(), "Choose");
...
//		assertEquals(driver.findElement(By.xpath("//div[3]/div[6]/h3")).getText(), "Coming Soon");
		...
		assertEquals(driver.findElement(By.xpath("//div[3]/div[7]")).getText(), "Ideal for heavy Geocoding use." + "\n" + "Get special savings and incentives.");
...
//		ip.isGetTextContainsByXPATH(driver, "//h5", "About Plan Overages");
//		assertEquals(driver.findElement(By.xpath("//div[2]/div/div/div[2]/p")).getText(),
//				"Your plan includes a maximum number of geocodes per month. "
//				+ "If you use more than that, we will bill you at the same \"per geocode\" price for your " +
//						"geocoding as you paid before you went over the limit.");
//		u.actionBuilderClick(driver, "//div[@id='overageMessageModal']/div/div/div[2]/button");
		u.clickByJavaScript(driver, "//div[@id='overageMessageModal']/div/div/div[2]/button");
	}
}
